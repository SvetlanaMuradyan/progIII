...
class Predator {
    ...
    move() {
        //որոնում է դատարկ տարածքներ
       var fundPrCords = this.getPrDirections(0);
        var prCord = random(fundPrCords);
    ...
    eat() {
        //հետազոտում է շրջակայքը, որոնում է սնունդ
        var fundCordsPr = this.getPrDirections(2);
        var cordPr = random(fundCordsPr);
        ...
        if (cordPr) {
            ...
            this.move();
            this.energy--;
            if (this.energy < 6) { //մահանում է, եթե էներգիան 3֊ից ցածր է
                this.die();
            }
        }
    }
